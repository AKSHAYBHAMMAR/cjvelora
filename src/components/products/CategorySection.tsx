...
export default function CategorySection({
  ...
  return (
    <section id="categories" className="scroll-mt-24 py-10 sm:py-20 px-3.5 sm:px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto">
      
      {/* Section Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6">
        <div>
          <div className="inline-flex items-center gap-2 mb-2 px-3 sm:px-3.5 py-1 rounded-full glass-panel border border-soft-gold/30">
            <Sparkles className="w-3 h-3 text-soft-gold" />
            <span className="font-tech text-[9px] sm:text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] text-olive-dark font-medium">
              Handmade Catalog
            </span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full font-sans text-xs uppercase tracking-widest font-semibold transition-all duration-300 flex items-center gap-2 cursor-pointer ${
