...
export async function PUT(req: NextRequest) {
  try {
    ...
    await defaultSupabase.from('featured_products').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    ...
    if (items.length > 0) {
      ...
      const { error: insertErr } = await defaultSupabase.from('featured_products').insert(rows);
      if (insertErr) {
